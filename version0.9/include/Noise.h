...
class Noise
{
  public:
    ...
    virtual void setParameters( const Noise_t& parameters ){std::cout<<"ooops! wrong coding3"<<std::endl;}
    virtual void getParameters( Noise_t& parameters ) const {std::cout<<"ooops! wrong coding4"<<std::endl;}
};
...
class FractalSum : public Noise
{
  public:
   ...
   ~FractalSum(){}
    ...
    {
       //std::cout<<"FSeval x: "<<x.X()<<" y: "<<x.Y()<<" z: "<<x.Z()<<std::endl;
       ...
       //std::cout<<"FSeval result: "<<accum+offset<<std::endl;
