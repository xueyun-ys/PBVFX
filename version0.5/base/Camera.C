...
Camera::Camera()
{
   ...
   //setEyeViewUp( Vector(20,0,0), Vector(-1,0,-0), Vector(0,1,0) );
   setEyeViewUp( Vector(0,10,20), Vector(0,0,-1), Vector(0,1,0) );
   setFov( 60.0 );
   //setAspectRatio( 16.0/9.0 );
   setAspectRatio( 4.0/3.0 );
   setNearPlane(0.0);//5
   //setNearPlane(0.0); //default
   setFarPlane(40.0);//35
   //setFarPlane(1.0e6); //default
}
